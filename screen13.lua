...
local v = ((Y+Y+Height)/2) - ((font_size*2) + 156)
if left_column_layout == "table" then
    for i, line in ipairs(text_right) do
        setNextFillColor(E, text_color.r, text_color.g, text_color.b, 1)
        setNextTextAlign(E, AlignH_Center, AlignV_Middle)
        addText(E, font, line[1], X2 -142, v)
        v = v + font_size + 14.5
    end
end
