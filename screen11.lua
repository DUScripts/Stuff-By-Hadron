...
local left_hub1 = "Hub 1 left Side"

local left_hub2 = "Hub 2 left Side"

local left_hub3 = "Hub 3 left Side"

local right_hub1 = "Hub 1 right Side"

local right_hub2 = "Hub 2 right Side"

local right_hub3 = "Hub 3 right Side"
...
setDefaultTextAlign(F, AlignH_Center, AlignV_Middle)
        addText(F, font, left_hub1, rx/2, Y1 + 7.5 )
       

        addText(F, font, left_hub2, rx/2, Y2 + 7.5 )
        

        addText(F, font, left_hub3, rx/2, Y3 + 7.5 )
        

        addText(F, font, right_hub1, rx/2, Y1 + Height1 - 7.25 )
        

        addText(F, font, right_hub2, rx/2, Y2 + Height1 - 7.25 )
        

        addText(F, font, right_hub3, rx/2, Y3 + Height1 - 7.25 )
